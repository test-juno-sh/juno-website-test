...
Take a look at our [detailed instructions](/self-signed-ssl){:target="_blank"} on how to configure certificates and enable SSL, so that you will be able to connect to your server from iPad.
